const Contact = () => {
  return (
    <form className="form container mx-auto flex flex-col  mt-40 items-center bg-white/75 rounded-2xl shadow-xl p-5 shadow-gray-300 border-2 border-white bg-gray-400 gap-10 overflow-hidden">
      ...
      <div className="form-control overflow-hidden flex flex-col md:flex-row gap-10 md:gap-20 ">
        <input
          type="text"
      ...
      <div className="form-control overflow-hidden  flex flex-col md:flex-row  gap-10 md:gap-20 rounded-lg">
        <input
          type="text"
      ...
      <button className="px-44 py-7 bg-red-700 text-gray-200 font-medium text-xl rounded-lg mb-10 md:w-[66rem]">
        Send Request
      </button>
    </form>
  );
